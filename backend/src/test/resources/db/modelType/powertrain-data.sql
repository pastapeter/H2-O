...
INSERT INTO powertrain_output(powertrain_id, output, min_rpm, max_rpm)
VALUES (1, 202.2, 1000, 1000),
       (2, 150.3, 2000, 2000);

INSERT INTO powertrain_torque(powertrain_id, torque, min_rpm, max_rpm)
VALUES (1, 100.1, 3000, 3000),
       (2, 199.2, 4500, 5500);
